 ...
 */
final class Version20190908121825 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD post_id INT DEFAULT NULL, CHANGE create_at create_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP post_id, CHANGE create_at create_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE post CHANGE created_at created_at DATETIME DEFAULT \'NULL\'');
