 ...
 */
final class Version20190913191434 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD mail VARCHAR(255) NOT NULL, CHANGE post_id post_id INT DEFAULT NULL, CHANGE create_at create_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP mail, CHANGE post_id post_id INT DEFAULT NULL, CHANGE create_at create_at DATETIME DEFAULT \'NULL\'');
